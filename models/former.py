...
#HW B C
a = torch.randn(256,2,512)
trans = TransformerSALayer(512)

position_emb = nn.Parameter(torch.zeros(256, 512))
pos = position_emb.unsqueeze(1).repeat(1,2,1)
b = trans(a,query_pos = pos)
